...
public class EmployeeFormationDAO {
     ...
     */
    public Formation updateFormation(final long id, final String name, final String description, final Formation.DegreeType level, final School school) {
        Formation formation = new Formation(name, description, level, school);
        formation.setId(id);
        em.merge(formation);
        em.flush();
        return formation;
     ...
     */
    public List<Formation> createFormation(final String name, final String description, final Formation.DegreeType level, final School school, final long employeeId) {
        Employee employee = em.find(Employee.class, employeeId);
        return createFormation(name, description, level, school, employee);
    }
     ...
     * @return the list of all the formations of the employee.
     */
    public List<Formation> createFormation(final String name, final String description, final Formation.DegreeType level, final School school, final Employee employee) {
        Formation formation = new Formation(name, description, level, school);
